...
describe('cropAlpha transform', function () {
  ...
  it('grey + alpha - some crop', function () {
    const image = new Image(
      ...
      4,
      [
        1, 0, 2, 255, 3, 255, 4, 0, 5, 255, 6, 255, 7, 0, 8, 255, 9, 255, 10, 0,
        11, 0, 12, 0,
      ],
      { kind: 'GREYA' },
    );
    ...
    expect(Array.from(cropped.data)).toStrictEqual([
      2, 255, 3, 255, 5, 255, 6, 255, 8, 255, 9, 255,
    ]);
  });
  ...
  it('grey + alpha - only one remains', function () {
    const image = new Image(
      ...
      4,
      [
        1, 0, 2, 0, 3, 0, 4, 0, 5, 255, 6, 0, 7, 0, 8, 0, 9, 0, 10, 0, 11, 0,
        12, 0,
      ],
      { kind: 'GREYA' },
    );
  ...
  it('grey + alpha - with threshold', function () {
    const image = new Image(
      ...
      4,
      [
        1, 0, 2, 240, 3, 0, 4, 110, 5, 255, 6, 250, 7, 110, 8, 239, 9, 250, 10,
        10, 11, 0, 12, 90,
      ],
      { kind: 'GREYA' },
    );
    ...
    expect(cropped.height).toBe(3);
    expect(Array.from(cropped.data)).toStrictEqual([
      2, 240, 3, 0, 5, 255, 6, 250, 8, 239, 9, 250,
    ]);
  });
  ...
  it('grey + alpha - error high threshold', function () {
    const image = new Image(
      ...
      4,
      [
        1, 40, 2, 240, 3, 50, 4, 110, 5, 0, 6, 250, 7, 110, 8, 239, 9, 250, 10,
        10, 11, 0, 12, 90,
      ],
      { kind: 'GREYA' },
    );
