...
export type TestImagePath =
  ...
  | 'formats/beachBallApng.png'
  | 'formats/bmp/10x2.bmp'
  | 'formats/bmp/2x2RGBA.bmp'
  | 'formats/bmp/5x5.bmp'
  | 'formats/bmp/6x4.bmp'
  | 'formats/bmp/6x4Grey.bmp'
  | 'formats/bmp/blackbuck.bmp'
  | 'formats/bmp/bmp_24.bmp'
  | 'formats/bmp/gray5x5.bmp'
  | 'formats/bwImage.png'
  | 'formats/grey6.jpg'
  | 'formats/grey8.png'
  | 'formats/grey12.jpg'
  ...
  | 'formats/greya16.png'
  | 'formats/greya32.png'
  | 'formats/magicHatTrns.png'
  | 'formats/plt-4bpp.png'
  | 'formats/plt-8bpp-color.png'
  | 'formats/polishedBasaltSide.png'
  | 'formats/rgb6.jpg'
  | 'formats/rgb12.jpg'
  | 'formats/rgb24.png'
  | 'formats/rgb48.png'
